  ...
  <?php
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <p class="text-muted mb-0">Более тысячи людей нашли работу!</p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <section class="p-0" id="portfolio">
      ...
      <div class="container-fluid p-0">
        ...
        <h2 >Найти работу будет просто.</h2> 
        <hr class="my-4">
          </div>
    ...
    <section >
      <div class="hint__container">
       ...
       <div class="container_text_center"> 
         ...
         <div class="hint__1">        
           <p class="hint__2">03</p>     
          <div class="container__hint-2">
           <h4  class="hint__text">
